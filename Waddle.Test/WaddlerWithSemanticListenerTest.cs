...
{
    public class WaddlerWithSemanticListenerTest
    {
        private void GetSystemUnderTest(IImmutableDictionary<string, FunctionDecl>? functions, ProgramSyntax? ast)
        {
        ...
        public void ThrowsOnIncompatibleTypesInDeclaration()
        {
            ...
            Assert.Throws<SemanticErrorException>(() => GetSystemUnderTest(functions, ast));
        }

            ...
            for ( ; pc < program.Length; pc++)
            {
                ...
                switch (instr.OpCode)
                {
                    ...
                    case OpCode.StoreLocalI32:
                        stack.Set(instr.IntegerArg, stack.Pop());
                        break;
                    case OpCode.LoadLocalI32:
                        stack.Push(new RuntimeValue(stack.Get(instr.IntegerArg).Integer));
                        break;
                    case OpCode.Branch:
                    ...
                    case OpCode.EqI32:
                        ...
                        {
                            stack.Push(new RuntimeValue(1));
                        }
                        else
                        {
                            stack.Push(new RuntimeValue(0));
                        }
                        break;
